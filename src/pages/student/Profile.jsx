...
import { 
  ...
  FiTrendingUp, FiCheckCircle, FiX 
} from 'react-icons/fi'
...
const StudentProfile = () => {
  ...
  const getStats = () => {
    ...
    return [
      { label: 'Exams Taken', value: examsTaken, icon: FiBook, color: '#6366f1' },
      { label: 'Passed', value: passedExams, icon: FiCheckCircle, color: '#10b981' },
      { label: 'Avg Score', value: `${avgScore}%`, icon: FiTrendingUp, color: '#8b5cf6' },
      { label: 'Rank', value: rank === '-' ? '-' : `#${rank}`, icon: FiAward, color: '#f59e0b' }
    ]
  }
      ...
      <div className="profile-header">
        ...
        <div className="profile-info">
          ...
          <div className="profile-meta">
            ...
            <span><FiMapPin /> {user?.college || 'N/A'}</span>
